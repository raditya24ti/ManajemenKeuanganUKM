...
@section('content')
    <div class="container py-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-5 gap-3">
            ...
            <a href="{{ route('users.create') }}" class="btn btn-primary px-4 py-2 shadow-blue fw-bold"
                ...
                <form action="{{ route('users.index') }}" method="GET" class="row g-3 align-items-center">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="role" class="form-select bg-dark text-white border-0 py-2 shadow-none"
                            style="border-radius: 10px; cursor: pointer;" onchange="this.form.submit()">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search"
                                ...
                                style="border-radius: 0 10px 10px 0;" placeholder="Cari nama atau email..."
                    ...
                    <div class="col-md-4 d-flex align-items-end gap-2 pt-md-4">
                        ...
                        <a href="{{ route('users.index') }}" class="btn btn-outline-secondary py-2 px-3"
                            style="border-radius: 10px;">
        ...
        <div class="mt-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            <div class="text-secondary small">
                Menampilkan <b>{{ $users->firstItem() ?? 0 }}</b> - <b>{{ $users->lastItem() ?? 0 }}</b> dari
                <b>{{ $users->total() }}</b> pengguna
            </div>
