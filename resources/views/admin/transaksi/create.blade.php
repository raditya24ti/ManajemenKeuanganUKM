                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('transaksi.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-dark border-0 text-primary"
                                            style="border-radius: 12px 0 0 12px;"><i class="fas fa-calendar-alt"></i></span>
                                ...
                                <div class="col-md-6 mb-4">
                                    <label class="form-label text-secondary small fw-bold text-uppercase">Jenis
                                        Transaksi</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="kategori"
                                        ...
                                        style="border-radius: 12px;" placeholder="Contoh: Iuran Kas"
                                        value="{{ old('kategori') }}" required>
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label class="form-label text-secondary small fw-bold text-uppercase">Nominal
                                        (Rp)</label>
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="jumlah"
                                            class="form-control bg-dark text-white border-0 py-2 shadow-none"
                                            style="border-radius: 0 12px 12px 0;" placeholder="0"
                            ...
                            <div class="mb-4">
                                <label class="form-label text-secondary small fw-bold text-uppercase">Keterangan
                                    Tambahan</label>
                            ...
                            <div class="mb-5">
                                <label class="form-label text-secondary small fw-bold text-uppercase">Bukti Transaksi
                                    (File)</label>
