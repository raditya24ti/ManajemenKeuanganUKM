...
@section('content')
    <div class="container py-5">
        <div class="mb-4">
            ...
            <p class="text-secondary" style="color: #8b949e !important;">Perbarui rincian arus kas masuk atau keluar
                organisasi Anda.</p>
        </div>
        ...
        <div class="card shadow-lg border-0" style="background-color: #1a1e26; border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="{{ route('transaksi.update', $transaksi->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label class="text-uppercase small font-weight-bold mb-2"
                                style="color: #8b949e !important;">TANGGAL</label>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="text-uppercase small font-weight-bold mb-2"
                                style="color: #8b949e !important;">JENIS TRANSAKSI</label>
                            <select name="jenis" class="form-select custom-input" required>
                                <option value="" disabled>-- Pilih Jenis --</option>
                                <option value="masuk" {{ $transaksi->jenis == 'masuk' ? 'selected' : '' }}>🟢 Pemasukan
                                </option>
                                <option value="keluar" {{ $transaksi->jenis == 'keluar' ? 'selected' : '' }}>🔴 Pengeluaran
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="kategori" class="form-control custom-input"
                                value="{{ old('kategori', $transaksi->kategori) }}" placeholder="Contoh: Iuran Kas"
                                required>
                        </div>

                        <div class="col-md-6 mb-4">
                            <label class="text-uppercase small font-weight-bold mb-2"
                                style="color: #8b949e !important;">NOMINAL (RP)</label>
                    ...
                    <div class="mb-5">
                        <label class="text-uppercase small font-weight-bold mb-2"
                            style="color: #8b949e !important;">KETERANGAN TAMBAHAN</label>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('transaksi.index') }}" class="text-secondary small font-weight-bold"
