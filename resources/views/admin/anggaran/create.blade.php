        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="mb-4 text-center text-md-start">
                    ...
                    <p class="text-secondary">Atur perencanaan dana sesuai kategori dan periode untuk kendali keuangan yang
                        lebih baik.</p>
                </div>
                ...
                <div class="card border-0 shadow-lg" style="background-color: #161b22; border-radius: 20px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('anggaran.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="nama_anggaran"
                                        ...
                                        style="border-radius: 12px;" placeholder="Contoh: Anggaran Kegiatan"
                                        value="{{ old('nama_anggaran') }}" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="kategori"
                                        class="form-control bg-dark text-white border-0 py-2 shadow-none"
                                        style="border-radius: 12px;" placeholder="Operasional / Acara"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label class="form-label text-secondary small fw-bold text-uppercase">Jumlah Anggaran
                                        (Rp)</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-dark border-0 text-white fw-bold"
                                            style="border-radius: 12px 0 0 12px;">Rp</span>
                                        <input type="number" name="jumlah_anggaran"
                                            class="form-control bg-dark text-white border-0 py-2 shadow-none"
                                            style="border-radius: 0 12px 12px 0;" placeholder="500000"
                                            value="{{ old('jumlah_anggaran') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-dark border-0 text-info"
                                            style="border-radius: 12px 0 0 12px;"><i class="fas fa-clock"></i></span>
                            ...
                            <div class="d-grid gap-3">
                                <button type="submit" class="btn btn-info btn-lg fw-bold shadow-info py-3 text-white"
                                    style="border-radius: 15px; background: linear-gradient(45deg, #0dcaf0, #00d4ff); border: none;">
