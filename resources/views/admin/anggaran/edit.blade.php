        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="mb-4 text-center text-md-start">
                    ...
                    <p class="text-secondary" style="color: #8b949e !important;">Perbarui detail perencanaan dana untuk
                        periode ini secara akurat.</p>
                </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('anggaran.update', $anggaran->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label class="text-uppercase small font-weight-bold mb-2"
                                        style="color: #8b949e !important;">Nama Anggaran</label>
                                    <input type="text" name="nama_anggaran" class="form-control custom-input"
                                        value="{{ old('nama_anggaran', $anggaran->nama_anggaran) }}"
                                        placeholder="Contoh: Operasional UKM" required>
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label class="text-uppercase small font-weight-bold mb-2"
                                        style="color: #8b949e !important;">Kategori</label>
                                    <input type="text" name="kategori" class="form-control custom-input"
                                        value="{{ old('kategori', $anggaran->kategori) }}" placeholder="Contoh: Kegiatan"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label class="text-uppercase small font-weight-bold mb-2"
                                        style="color: #8b949e !important;">Jumlah Anggaran (Rp)</label>
                                    <input type="number" name="jumlah_anggaran" class="form-control custom-input"
                                        value="{{ old('jumlah_anggaran', $anggaran->jumlah_anggaran) }}" placeholder="0"
                                        required>
                                </div>

                                <div class="col-md-6 mb-4">
                                    <label class="text-uppercase small font-weight-bold mb-2"
                                        style="color: #8b949e !important;">Periode</label>
                            ...
                            <div class="mb-5">
                                <label class="text-uppercase small font-weight-bold mb-2"
                                    style="color: #8b949e !important;">Keterangan</label>
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ route('anggaran.index') }}" class="text-secondary small font-weight-bold"
