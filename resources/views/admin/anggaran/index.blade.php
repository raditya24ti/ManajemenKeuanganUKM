...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4">
            ...
            <a href="{{ route('anggaran.create') }}" class="btn btn-primary px-4 py-2 shadow-blue fw-bold"
                ...
                <form action="{{ route('anggaran.index') }}" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="month" name="periode"
                            class="form-control bg-dark text-white border-0 py-2 shadow-none" style="border-radius: 10px;"
                            value="{{ request('periode') }}" onchange="this.form.submit()">
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search"
                                ...
                                style="border-radius: 0 10px 10px 0;" placeholder="Cari nama anggaran..."
                    ...
                    <div class="col-md-4 d-flex gap-2">
                        ...
                        <a href="{{ route('anggaran.index') }}" class="btn btn-outline-secondary py-2 px-3"
                            style="border-radius: 10px; border-color: #30363d;">
                            ...
                            <tr class="border-bottom border-secondary border-opacity-10">
                                ...
                                <td>
                                    <span class="badge rounded-pill"
                                        style="background: rgba(13, 110, 253, 0.1); color: #3498db; border: 1px solid rgba(52, 152, 219, 0.2);">
                                        {{ $a->kategori }}
                                    </span>
                                </td>
                                    ...
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <form action="{{ route('anggaran.destroy', $a->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-sm btn-icon-hover text-danger"
                                                onclick="return confirm('Hapus anggaran ini?')">
        ...
        <div class="mt-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            <div class="text-secondary small">
                Menampilkan <b>{{ $anggaran->firstItem() ?? 0 }}</b> - <b>{{ $anggaran->lastItem() ?? 0 }}</b> dari
                <b>{{ $anggaran->total() }}</b> anggaran
            </div>
